...
from
    ...
    left join user_word uw on uw.user_id = ujb.user_id
    ...
    left join book_sentence_has_word bw on bw.book_sentence_id = bp.id and bw.word_id is not null and uw.word_id = bw.word_id
