<template>
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <b-navbar-brand class="logo" b-link to="/">
            ...
            <span v-text="$t('global.title')" class="navbar-title">lib_four</span> <span class="navbar-version">{{version}}</span>
        </b-navbar-brand>      
        <b-navbar-toggle 
        right 
        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/dictionary">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.dictionary')">Dictionary</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/word">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.word')">Word</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/dictionary-has-word">
                        <font-awesome-icon icon="asterisk" />
