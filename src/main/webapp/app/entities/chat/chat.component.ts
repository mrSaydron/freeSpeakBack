...
export default class Chat extends mixins(JhiDataUtils, AlertMixin) {
  ...
  public prepareRemove(instance: IChat): void {
  ...
  public removeChat(): void {
    this.chatService()
      ...
      .then(() => {
        const message = this.$t('libFourApp.chat.deleted', { param: this.removeId });
